...
public class ZapiBase
{
	 ...
	 * @throws Exception
	 */
	public void getData(String cycle_Issue) throws Exception 
	{
...
//		Issue_Key = rd.getValue("DATA", currentTest, "JIRA_IssueKey");
	...
	public Map<String, Map<String, String>> getListOfCycles(String versionName) throws Exception {
		...
		Map<String, String> listOfCycles = new HashMap<String, String>();
	...
	public String getAppProperties(String key)
	{
		...
		try {
			...
			FileInputStream fileInputStream = new FileInputStream("GlobalSettings.properties");
